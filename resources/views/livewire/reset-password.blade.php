<div>
    ...
    <x-icon-button wire:loading.remove icon="key" data-modal-target="popup-modal-{{ $userId }}"
                   data-modal-toggle="popup-modal-{{ $userId }}" />

    <div role="status" wire:loading.flex wire:target="resetPassword()"
         class=" flex items-center justify-center">
        <svg aria-hidden="true" class="w-6 h-6 text-gray-200 animate-spin dark:text-gray-600 fill-primary"
        ...
        <div class="relative p-4 w-full max-w-md max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-neutral4">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-neutral4 dark:text-neutral4">Seguro que quieres enviar el correo de recuperación de contraseña?</h3>
                    <button wire:click="resetPassword" data-modal-hide="popup-modal-{{ $userId }}" type="button"
                            class="text-white bg-primary hover:bg-primary4 focus:ring-4 focus:outline-none  dark:focus:primary4 font-medium rounded-lg text-sm inline-flex items-center px-5 py-2.5 text-center">
                        Enviar
                    </button>
